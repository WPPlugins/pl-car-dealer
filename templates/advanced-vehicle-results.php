...
$_make = $_GET['make'] != '0' ? $_GET['make'] : null;
 (int) $_mileage = ($_GET['maxmil'] != '') ? $_GET['maxmil'] : 500000;
$_price = $_GET['maxprice'] != '' ? $_GET['maxprice'] : 1000000;
$_year = $_GET['minyear'] != '' ? $_GET['minyear'] : 0;
